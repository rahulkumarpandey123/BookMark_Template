...
I:"ytp-miniplayer-ui"});this.Bg=!1;this.player=a;this.K(a,"minimized",this.Ai);this.K(a,"onStateChange",this.qP)},Q5=function(a){g.pN.call(this,a);
...
g.k.show=function(){this.jd=new g.pn(this.Mo,null,this);this.jd.start();if(!this.Bg){this.tooltip=new g.vS(this.player,this);g.E(this,this.tooltip);g.dN(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Ab=new g.hP(this.player);g.E(this,this.Ab);this.Ij=new g.X({D:"div",I:"ytp-miniplayer-scrim"});g.E(this,this.Ij);this.Ij.Z(this.element);this.K(this.Ij.element,"click",this.CD);var a=new g.X({D:"button",ca:["ytp-miniplayer-close-button","ytp-button"],P:{"aria-label":"Close"},L:[g.TN()]});
g.E(this,a);a.Z(this.Ij.element);this.K(a.element,"click",this.Cm);a=new O5(this.player,this);g.E(this,a);a.Z(this.Ij.element);this.gk=new g.X({D:"div",I:"ytp-miniplayer-controls"});g.E(this,this.gk);this.gk.Z(this.Ij.element);this.K(this.gk.element,"click",this.CD);var b=new g.X({D:"div",I:"ytp-miniplayer-button-container"});g.E(this,b);b.Z(this.gk.element);a=new g.X({D:"div",I:"ytp-miniplayer-play-button-container"});g.E(this,a);a.Z(this.gk.element);var c=new g.X({D:"div",I:"ytp-miniplayer-button-container"});
g.E(this,c);c.Z(this.gk.element);this.ZD=new g.gR(this.player,this,!1);g.E(this,this.ZD);this.ZD.Z(b.element);b=new g.dR(this.player,this);g.E(this,b);b.Z(a.element);this.nextButton=new g.gR(this.player,this,!0);g.E(this,this.nextButton);this.nextButton.Z(c.element);this.Zg=new g.kS(this.player,this);g.E(this,this.Zg);this.Zg.Z(this.Ij.element);this.Gc=new g.pR(this.player,this);g.E(this,this.Gc);g.dN(this.player,this.Gc.element,4);this.Ir=new g.X({D:"div",I:"ytp-miniplayer-buttons"});g.E(this,this.Ir);
g.dN(this.player,this.Ir.element,4);a=new g.X({D:"button",ca:["ytp-miniplayer-close-button","ytp-button"],P:{"aria-label":"Close"},L:[g.TN()]});g.E(this,a);a.Z(this.Ir.element);this.K(a.element,"click",this.Cm);a=new g.X({D:"button",ca:["ytp-miniplayer-replay-button","ytp-button"],P:{"aria-label":"Close"},L:[g.fO()]});g.E(this,a);a.Z(this.Ir.element);this.K(a.element,"click",this.uN);this.K(this.player,"presentingplayerstatechange",this.Lb);this.K(this.player,"appresize",this.Na);this.K(this.player,
...
g.k.uN=function(){this.player.playVideo()};
g.k.CD=function(a){if(a.target===this.Ij.element||a.target===this.gk.element)g.P(this.player.M().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.cI(g.MM(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.la("onExpandMiniplayer")};
...
g.k.Mo=function(){this.Bd();this.jd&&this.jd.start()};
g.k.Lb=function(a){g.U(a.state,32)&&this.tooltip.hide()};
g.k.Na=function(){this.Gc.setPosition(0,g.NM(this.player).getPlayerSize().width,!1);this.Gc.hy()};
g.k.qP=function(a){this.player.app.N.o&&(0===a?this.hide():this.show())};
